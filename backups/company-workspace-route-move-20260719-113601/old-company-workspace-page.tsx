...
export default function CompanyWorkspacePage() {
  ...
  return (
    <main
      className="company-workspace-page min-h-[calc(100vh-76px)] bg-[var(--background)] px-4 py-5 sm:px-5 md:px-7 md:py-6 xl:px-8"
      dir={locale === "ar" ? "rtl" : "ltr"}
    >
      <div className="mx-auto max-w-[1480px] space-y-5 md:space-y-6">
        <CompanyHero
          locale={locale}
          name={
            company.name ||
